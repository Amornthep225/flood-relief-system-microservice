...
{
    public class CentersService : ControllerBase
    {
        private readonly AppDbContext _context;

        public CentersService(AppDbContext context)
        {
            _context = context;
        }
            ...
            CreateCenterRequestDto dto)
        {
            ...
            {
                Id = await PrimaryKeyHelper.GenerateNextIdAsync(
                    _context.Centers,
                    x => x.Id,
                    "Center",
                    digits: 5),
